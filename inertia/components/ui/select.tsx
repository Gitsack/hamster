    ...
    <SelectPortal>
      <SelectPositioner>
        <BaseSelect.Popup
          ...
          className={cn(
            'bg-popover text-popover-foreground border-border relative z-[9999] max-h-[min(var(--available-height),20rem)] min-w-[8rem] overflow-y-auto overflow-x-hidden rounded-lg border p-1 shadow-lg',
            className
          )}
          {...props}
        >
